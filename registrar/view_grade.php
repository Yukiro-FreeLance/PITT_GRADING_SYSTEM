...
<?php $get_id = $_GET['id']; ?>
	...
	<div class="logo_Sti"></div>
		<div class="margin-top">
			...
			<div class="span12">
			<?php
			$student_query=mysqli_query($connection,"select * from students where student_id = '$get_id'")or die(mysqli_error($connection));
			...
			<div class="span10">
                            <table cellpadding="0" cellspacing="0" border="0" class="table  table-bordered" id="example">                      
                                ...
                                <tbody>
                                  ...
                                  <?php  $user_query=mysqli_query($connection,"select * from grade where student_id = '$get_id' and school_year = '$school_year' and semester = '$term' ")or die(mysqli_error($connection));
