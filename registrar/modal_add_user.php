	...
	mysqli_query($connection,"insert into users (username,password,firstname,lastname,user_type) values('$username','$password','$firstname','$lastname','$user_type')")or die(mysqli_error($connection,));
	}
	?>