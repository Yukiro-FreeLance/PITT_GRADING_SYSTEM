    ...
    <footer class="footer">
	  ...
	  <div class="foot-margin">
        <p>&copy;<a>PIT Tabango STUDENTS' GRADE INFORMATION SYSTEM</span></strong> - <?php echo date('Y');?> -  Program by: <strong style="color:green">Wendel Luche and Jessie Cuna</a></p>
      </div>
      </div>
    </footer>
